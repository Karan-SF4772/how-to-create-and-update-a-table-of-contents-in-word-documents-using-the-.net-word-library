...
A quick start project that shows how to create and update a Table of Contents in Word Documents using the [.NET Word library](https://www.syncfusion.com/document-sdk/net-word-library) (DocIO).
...
*   **Documentation:** [Table of Contents](https://help.syncfusion.com/document-processing/word/word-library/net/working-with-table-of-contents)
